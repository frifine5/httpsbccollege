...
<div style="width:30%; text-align: center; margin: 0 auto;">
	<form class="form-signin" action="./signIn">       
      ...
      <button class="btn btn-lg btn-primary btn-block" type="submit" style="width: 60px; margin: 0 auto; " >Login</button> 
      <p class="sign-up"><a href="./register"><strong>Sign up</strong> for a new account</a></p>  
    </form>
</div>
